...
WinscopeModule::WinscopeModule(ProtoImporterModuleContext* module_context,
  ...
  RegisterForField(
      FrameworksBaseWinscopeTracePacket::kProtologMessageFieldNumber);
  RegisterForField(
      FrameworksBaseWinscopeTracePacket::kProtologViewerConfigFieldNumber);
  RegisterForField(
...
ModuleResult WinscopeModule::TokenizePacket(
    ...
    uint32_t field_id) {
  switch (field_id) {
    case FrameworksBaseWinscopeTracePacket::kProtologViewerConfigFieldNumber:
    ...
    case FrameworksBaseWinscopeTracePacket::kShellHandlerMappingsFieldNumber:
      shell_transitions_parser_.ParseHandlerMappings(
          decoder
              ...
              .as_bytes());
      return;
    case FrameworksBaseWinscopeTracePacket::kProtologMessageFieldNumber:
